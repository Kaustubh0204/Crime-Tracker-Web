...
function reply_click(clicked_id) {
    ...
    db.collection("report").where("caseid", "==", String(clicked_id))
        .get()
        .then((querySnapshot) => {
            querySnapshot.forEach((doc) => {
